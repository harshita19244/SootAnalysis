...
//        int depth = sc.nextInt();
        ...
        String newdir = "C:\\Users\\USer\\dubbosoot\\src\\main\\java";
        ...
        SootClass c = Scene.v().forceResolve("org.apache.dubbo.rpc.protocol.dubbo.ReferenceCountExchangeClient", SootClass.BODIES);
        System.out.println(c.getName());
        c.setApplicationClass();
        Scene.v().loadNecessaryClasses();
        SootMethod src = c.getMethodByName("getRemoteAddress");
