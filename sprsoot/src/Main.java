...
//        int depth = sc.nextInt();
        ...
        String newdir = "C:\\Users\\USer\\sprsoot\\src";
        ...
        SootClass c = Scene.v().forceResolve("org.springframework.http.codec.protobuf.ProtobufHttpMessageWriter", SootClass.BODIES);
        System.out.println(c.getName());
        c.setApplicationClass();
        Scene.v().loadNecessaryClasses();
        SootMethod src = c.getMethodByName("ProtobufHttpMessageWriter");
