...
public class AllJavaDocExtracter {
    ...
    public static void main(String[] args) throws IOException {
        String pathname = "C:\\Users\\USer\\spring-boot\\spring-boot-project\\spring-boot-tools\\spring-boot-jarmode-layertools\\src\\main\\java\\org\\springframework\\boot\\jarmode";
        File output = new File("C:\\Users\\USer\\spring-boot\\output20.txt");
