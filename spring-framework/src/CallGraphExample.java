...
public class CallGraphExample
{
    ...
    public static void main(String[] args) {
        ...
        Scene.v().extendSootClassPath("C:\\Users\\USer\\sootrun\\src");
        System.out.println("Classpath: " + Scene.v().getSootClassPath());
        SootClass c = Scene.v().forceResolve("org.springframework.messaging.rsocket.PayloadUtils", SootClass.BODIES);
        c.setApplicationClass();
        Scene.v().loadNecessaryClasses();
        Scene.v().loadNecessaryClasses();
        SootMethod src = c.getMethodByName("asByteBuf");
