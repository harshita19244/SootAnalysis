...
public class CallGraphExample
{
    ...
    public static void main(String[] args) {
        ...
        exclusions.add("kotlin.reflect");
        exclusions.add("kotlin.full");
        exclusions.add("kotlin.jvm");
        Options.v().set_no_bodies_for_excluded(true);
        Options.v().set_exclude(exclusions);
        System.out.println("Classpath: " + Scene.v().getSootClassPath());
        Scene.v().extendSootClassPath("C:\\Users\\USer\\Desktop\\SootAnalysis\\spring-framework\\src");
        System.out.println("Classpath: " + Scene.v().getSootClassPath());
        SootClass c = Scene.v().forceResolve("org.springframework.http.client.MultipartBodyBuilder", SootClass.BODIES);
        c.setApplicationClass();
        Scene.v().loadNecessaryClasses();
        Scene.v().loadNecessaryClasses();
        List<SootMethod> sr = c.getMethods();
        //System.out.println(sr);
        SootMethod src = getMethodMatch("part",sr,"String name, Object part, @Nullable MediaType contentType","Object");
        //SootMethod src = c.getMethodByName("part");
//        if(src==null){
//            System.out.println();
//        }
